  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white/90 backdrop-blur-md shadow-sm py-3' : 'bg-transparent py-6'}`}>
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <a href="/" className="flex items-center gap-2 rounded-lg focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#FF6321]">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href={eventHasPassed ? GAME_RULES_URL : REGISTRATION_URL}
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              {eventHasPassed ? 'View Game Rules' : 'Join the Competition'}
            ...
            {eventHasPassed ? (
              <div className="bg-white/5 border border-white/10 rounded-2xl p-5 inline-block backdrop-blur-sm shadow-xl">
                <p className="text-slate-400 text-xs uppercase tracking-widest mb-4 font-bold flex items-center gap-2">
                  <Calendar size={14} className="text-[#FF6321]" />
                  Festival Date
                </p>
                <div className="grid gap-3 text-sm text-slate-300 sm:grid-cols-2">
                  <p><span className="block text-2xl font-black text-white">April 11, 2026</span>Dipolog City</p>
                  <p><span className="block text-2xl font-black text-white">ZDN</span>Cultural and Sports Center</p>
                </div>
              </div>
            ) : (
              <div className="bg-white/5 border border-white/10 rounded-2xl p-5 inline-block backdrop-blur-sm shadow-xl">
...
const Competitions = () => {
  const eventHasPassed = new Date().getTime() > new Date('2026-04-11T17:00:00+08:00').getTime();
    ...
    <section id="competitions" className="py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mt-16 bg-[#003366] rounded-[2.5rem] p-12 text-center text-white relative overflow-hidden">
          ...
          <h4 className="text-3xl font-black mb-4">{eventHasPassed ? 'Explore the competition rules' : 'Ready to compete?'}</h4>
          <p className="text-blue-100/80 mb-8 max-w-xl mx-auto">
            {eventHasPassed
              ? 'Review the official game rules and categories from the first-ever robotics festival in Dipolog City.'
          ...
          >
            {eventHasPassed ? 'View Game Rules' : 'Register for Free'}
          </a>
        </div>
      </div>
    </section>
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="text-xl font-bold text-slate-900 mb-2">Event Date</h4>
                  <p className="text-slate-600 leading-relaxed">
                    April 11, 2026. <br />
    ...
    <footer className="bg-slate-900 pt-20 pb-10 text-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400">
              <li><a href="/" className="hover:text-white transition-colors">Makerverse Home</a></li>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-slate-500 text-sm">
          <p>© {year} Makerverse. All rights reserved.</p>
