...
const TEAMS_TAB = 'Sumobot Teams List';
const RESULTS_TAB = 'Sumobot';
...
export default function SumobotBracketPage() {
  ...
  const syncFromSheet = async () => {
    try {
      ...
      if (teamNames.length < 2) {
        throw new Error('Need at least 2 teams in "Sumobot Teams List" (column A).');
      }
    ...
    <div className="min-h-screen bg-slate-100">
      <header className="bg-slate-900 text-white py-6 px-6 border-b border-slate-800">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
          <div>
            <p className="text-orange-400 text-xs uppercase tracking-[0.2em] font-bold">SumoBot Tournament</p>
